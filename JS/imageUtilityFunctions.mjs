...
export function addImage(imageArray, index, chosenOptgroup, chosenOption) {
  ...
  imgEle.src = `../images/${lowerCaseOptGroup}/${lowerCaseOption}/${imageArray[index]}.jpg`;
  imgEle.alt = `A picture of a ${imageArray[index]}`;
  imgEle.title = `${imageArray[index]}`;
  imgEle.srcset = `
    ../images/${lowerCaseOptGroup}/${lowerCaseOption}/${imageArray[index]}-sm.jpg 76w,
    ../images/${lowerCaseOptGroup}/${lowerCaseOption}/${imageArray[index]}-md.jpg 130w,
    ../images/${lowerCaseOptGroup}/${lowerCaseOption}/${imageArray[index]}-lg.jpg 190w,
    ../images/${lowerCaseOptGroup}/${lowerCaseOption}/${imageArray[index]}-xlg.jpg 250w
  `;
  imgEle.sizes = `
